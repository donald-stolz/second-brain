...
3. Identify related notes by matching:
   - Shared tags across notes in different folders
   - Similar keywords in summaries
...
4. For each pair of related notes:
   ...
   b. Add a wikilink `[[Note Name]]` in the appropriate section:
   ...
   c. Update the `modified` date on both notes.
...
- Do not create duplicate wikilinks — check if a link already exists before adding.
